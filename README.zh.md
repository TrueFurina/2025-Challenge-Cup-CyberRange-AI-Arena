# 2025挑战杯 · AI驱动动态攻防推演靶场

安恒信息揭榜挂帅合作赛题作品

> **English version**: [README.md](README.md)

基于 AI Agent 的动态攻防推演靶场平台，是第十九届"挑战杯"2025 揭榜挂帅擂台赛（人工智能领域-SH24，**安恒信息发榜**）合作赛题作品。平台用 AI Agent 替代人工红蓝队，实现**动态场景生成、智能攻击模拟、自适应防御决策、演练评估自动化**四大核心功能。
