...
CORS(app, resources={r"/api/*": {"origins": ["http://127.0.0.1", "http://localhost", "http://127.0.0.1:5000", "http://localhost:5000"]}})
...
with app.app_context():
    ...
    def init_db():
        ...
        test_students = [
            {'username': 'student1', 'email': 'student1@example.com', 'real_name': '张三', 'student_id': '20240001'},
            {'username': 'student2', 'email': 'student2@example.com', 'real_name': '李四', 'student_id': '20240002'},
            {'username': 'test', 'email': 'test@example.com', 'real_name': '测试用户', 'student_id': '20240003'}
        ]
...
@app.route('/test_blackbox_report.html')
def test_blackbox_report():
    # Serve the test file directly from the root directory
    from flask import send_from_directory
    return send_from_directory('.', 'test_blackbox_report.html')
